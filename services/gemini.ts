...
if (!API_KEY) {
  console.warn("Gemini API key not found. AI Helper will not work. Please set the VITE_GEMINI_API_KEY environment variable in your .env file and restart the dev server.");
}
