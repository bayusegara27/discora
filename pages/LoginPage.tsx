...
const LoginPage: React.FC = () => {
    ...
    const { login, user, authError, setAuthError, loginWithDiscord } = useAuth();
            ...
            <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center">
                        ...
                        <h2 className="mt-6 text-3xl font-bold tracking-tight text-text-primary">Welcome Back!</h2>
                        <p className="mt-2 text-text-secondary">Log in to manage your Discora bot.</p>
                    </div>
