...
const LeaderboardPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    appwriteService
      .getLeaderboard(selectedServer.guildId)
      .then(setLeaderboard)
  ...
  if (!selectedServer) {
    return (
      <div className="text-center text-text-secondary">
        Please select a server to view the leaderboard.
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-text-secondary">
          Top 100 most active members in {selectedServer.name}.
        </p>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-left">
            <thead className="border-b border-gray-700">
              <tr>
                <th className="p-4 text-sm font-semibold text-text-secondary w-16 text-center">
                  Rank
                </th>
                <th className="p-4 text-sm font-semibold text-text-secondary">
                  User
                </th>
                <th className="p-4 text-sm font-semibold text-text-secondary text-center">
                  Level
                </th>
                <th className="p-4 text-sm font-semibold text-text-secondary">
                  XP Progress
            ...
            <tbody>
              {leaderboard.length > 0 ? (
                ...
                <tr>
                  ...
                  >
                    No one has earned XP yet in {selectedServer.name}.
                  </td>
                </tr>
              )}
            </tbody>
